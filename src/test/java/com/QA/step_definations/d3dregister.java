...
public class d3dregister extends opendriver {
    ...
    @Then("^I should see \"([^\"]*)\" in d(\\d+)d security site$")
    public void iShouldSeeInDDSecuritySite(String myaccount, int arg1) throws Throwable {

        String inbox;

        inbox = driver.findElement(By.xpath(".//*[@id='post-4519']/div/div[1]/p")).getText();

        assertEquals(inbox,myaccount);
